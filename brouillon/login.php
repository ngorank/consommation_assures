	...
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4"style="color:orange">Code de Demande de Carte</h3>
		      		...
		      		<div class="form-group">
		      			<input type="text" name='numeroidentification' class="form-control rounded-left" placeholder="CB09-1450" required>
		      		</div>
	            ...
	            <div class="form-group">
	            	<button type="submit" name="seConnecter1"  class=" btn-warning rounded submit p-3 px-5" style="background-color:orange">Se Connecter</button>
	            </div>
	          </form>
	        </div>
				</div>
