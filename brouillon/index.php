<?php	
 session_start();  
  $numeroidentification=$_SESSION["numeroidentification"];
 ...
 require('db_conn.php');	
$sql=$conn->query("SELECT * FROM baseofficielle WHERE numeroidentification='$numeroidentification' ");											
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                      <p style='color:red'> 
                      Cette fiche permet de vérifier s'il n'y a pas d'erreurs dans vos
                        informations
                      </p>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                   ...
                   <img src="http://badogec.com/badogec/pages/static/temp/<?php echo $resultat['imageqrcode']; ?>" width="150px">
                    </div>
                  </div>
                  <hr>
                  
  <p style="text-align:center; background-color:#ccc; border-radius:100px">
    <h3>Pour plus d'informations:<b style="color:red"> 07 08 26 45 01 </b> </h3> </p>
                  <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-info" href="login.php">Retour</a>
